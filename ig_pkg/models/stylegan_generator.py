...
def StyleGANGenerator(resolution = 1024):
    ...
    # g_all.load_state_dict(torch.load(os.path.join(f'pretrained_weights_torch/{name}-{data}-{res}x{res}.pt')))
...
class LayerEpilogue(nn.Module):
    ...
    def __init__(self, channels, dlatent_size, use_wscale, use_noise, use_pixel_norm, use_instance_norm, use_styles, activation_layer):
        ...
        if use_pixel_norm:
            layers.append(('pixel_norm', PixelNormLayer())) ### PixelNorm -> PixelNormLayer
