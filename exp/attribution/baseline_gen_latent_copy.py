...
for idx in pbar:
    ...
    # baseline = valid_dataset[ran][0].to(args.device)    
        
    # x_hat, loss_dict, info1 = AutoencoderExaminer.reconstruct_input(ae, input.unsqueeze(0))    
    # x_hat, loss_dict, info2 = AutoencoderExaminer.reconstruct_input(ae, baseline.unsqueeze(0))    
    ...
    #     temp = AutoencoderExaminer.reconstruct_latent(ae, interp_z[i]) # 1, 3, 32, 32
    #     interp.append(temp.squeeze(0))    
...
np.save('/home/dhlee/results/cifar10/latent_gradient_interpolation_z.npy', interpolation_z.numpy())
np.save('/home/dhlee/results/cifar10/latent_gradient_interpolation.npy', interpolation.numpy())
np.save('/home/dhlee/results/cifar10/latent_gradient_attribution.npy', attribution.numpy())
